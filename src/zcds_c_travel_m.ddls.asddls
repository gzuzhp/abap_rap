  ...
  as projection on ZCDS_I_TRAVEL_M
{
  ...
  key     travel_id          as TravelID,
          ...
          /* Associations */
          _Booking : redirected to composition child ZCDS_C_BOOKING_M,
          _Agency,
          _Customer,
          @UI: {
          lineItem: [ { position: 60, importance: #HIGH } ] }
          @Semantics.amount.currencyCode: 'CurrencyCode'
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_VIRTUAL'
          @EndUserText.label: 'Total (10%)'
  virtual virt_field : /dmo/total_price
}
